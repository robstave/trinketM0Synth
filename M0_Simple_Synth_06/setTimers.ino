...
// The Basic strategy for the LFO is to track an ADDITIONAL counter and flip the 
// LFO value accordingly.
// # define minLFO 500  means that we flip the LFO bit at
// 469/( 500 * 2) = .46 HZ.
// # define maxLFO 40  means that we flip the LFO bit at
// 469/( 40 * 2) = 5.8625 HZ.
